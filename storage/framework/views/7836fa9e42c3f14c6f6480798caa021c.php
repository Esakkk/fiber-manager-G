...
<head>
    ...
    <title>Manajemen User - Fiber Manager</title>
...
<body>
    <div class="user-management">
        <div class="header">
            <div>
                ...
                <p style="color: #718096; margin-top: 5px;">Kelola pengguna aplikasi Fiber Manager</p>
            </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="userForm">
                    ...
                    <div class="form-group">
                        <label>Password * <small id="passwordHint">(minimal 6 karakter)</small></label>
                    ...
                    <div class="form-group">
                        <label>Catatan</label>
                        <textarea id="userNotes" rows="2"></textarea>
                    </div>
                </form>
            </div>
            <div class="modal-footer">
                <button class="btn btn-danger" onclick="closeModal('userModal')">Batal</button>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input type="password" id="newPassword" minlength="6" placeholder="Minimal 6 karakter">
                </div>
                <div class="form-group">
    ...
    <script>
        ...
        function renderUserTable(users) {
            ...
            tbody.innerHTML = users.map(user => `
                <tr>
                    ...
                    <td>${user.last_login ? new Date(user.last_login).toLocaleString('id-ID') : 'Never'}</td>
                    <td>
                        <button class="btn btn-sm btn-primary" onclick="editUser(${user.id})" title="Edit">
                            <i class="fas fa-edit"></i>
                        </button>
                        <button class="btn btn-sm btn-secondary" onclick="showResetPasswordModal(${user.id})" title="Reset Password">
                            <i class="fas fa-key"></i>
                        </button>
                        <button class="btn btn-sm btn-danger" onclick="deleteUser(${user.id}, '${user.username}')" title="Hapus">
        ...
        async function saveUser() {
            ...
            try {
                ...
                if (response.ok) {
                    ...
                    showMessage(result.error || 'Gagal menyimpan user', 'error');
                }
            } catch (error) {
                console.error('Error:', error);
                showMessage('Gagal menyimpan user', 'error');
            }
        }
        ...
        async function resetUserPassword() {
            ...
            try {
                const response = await fetch(`${API_BASE}/users.php?id=${id}&action=reset-password`, {
                    method: 'PUT',
                    headers: { 'Content-Type': 'application/json' },
                ...
                if (response.ok) {
                    ...
                    showMessage(result.error || 'Gagal mereset password', 'error');
                }
            } catch (error) {
                console.error('Error:', error);
        ...
        async function deleteUser(id, username) {
            ...
            try {
                ...
                if (response.ok) {
                    ...
                    showMessage(result.error || 'Gagal menghapus user', 'error');
                }
            } catch (error) {
                console.error('Error:', error);
...
<?php /**PATH D:\Ngoding\RepoGithub\fiber-manager-G\resources\views/users.blade.php ENDPATH**/ ?>